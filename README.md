...
The bot uses conversational AI models combined with contextual memory and specialized emotional prompts to maintain supportive and natural dialogue. Users can interact through both text and voice messages in Ukrainian or English.
...
To improve realism and reduce repetitive or inappropriate responses, the bot maintains lightweight rolling conversation memory that preserves recent context while remaining computationally efficient for hackathon deployment.
